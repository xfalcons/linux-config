...
function promptcmd () {
    ...
    # Working directory
    if [ -w "${PWD}" ]; then 
        PS1="${PS1}\[${COLOR_GREEN}\]$(prompt_workingdir) \[\033[31m\]\$(parse_git_branch)\[\033[00m\]"
    else                                 
        PS1="${PS1}\[${COLOR_RED}\]$(prompt_workingdir) \[\033[31m\]\$(parse_git_branch)\[\033[00m\]"
    fi
